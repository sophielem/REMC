...
class Corner_moves(Movement.Movement):
  ...
  def mutation(self, structure_grid):
    ...
    freedom_neighbour_next = self.residu.next_res.search_free_neighbour(structure_grid)
    freedom_neighbour_prev = self.residu.previous_res.search_free_neighbour(structure_grid)
